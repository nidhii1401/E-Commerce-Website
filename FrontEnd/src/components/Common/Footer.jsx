...
const Footer = () => {
  return (
    <footer className="border-t py-12 px-20">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-4 gap-8 px-4">
        <div>
          ...
          <form className="flex">
            <input
              ...
              className="p-3 w-full text-sm border-t border-l border-b border-gray-300 rounded-all-md focus:outline-none focus:ring-2
        ...
        {/* follow us */}
        <div>
          <h3 className="text-lg text-gray-800 mb-">Follow Us</h3>
